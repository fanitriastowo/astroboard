defmodule Astroboard.Accounts do
  @moduledoc """
  ...
  alias Astroboard.Accounts.{User, UserToken, UserNotifier}
  ...
  See `Astroboard.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `Astroboard.Accounts.User.password_changeset/3` for a list of supported options.
